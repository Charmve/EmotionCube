...
static unsigned char index_level = 1;
	const char* cube[130] = {"0:CUB1.txt","0:CUB2.txt","0:CUB3.txt","0:CUB4.txt","0:CUB5.txt",
...
//												   "0:CUB496.txt","0:CUB497.txt","0:CUB498.txt","0:CUB499.txt"
	...
	const char* MagicDy[12]={"0:magic1.txt","0:magic2.txt","0:magic3.txt","0:magic4.txt","0:magic5.txt",
													 "0:magic6.txt","0:magic7.txt","0:magic8.txt","0:magic9.txt","0:magic10.txt",
													 "0:magic11.txt","0:magic12.txt"
	};
...
/*******************************************************************************
* Function Name  : ShowMagicDy(void)
* Description    : 游戏魔方动态演示
* Input          : None
* Output         : None
* Return         : None
* Attention		   : None
*******************************************************************************/
void ShowMagicDy(void)
{
	int File_index=0;
	speed = 10;
	for(File_index=0;File_index<12;File_index++)
	{
		TFCard_Init();		
		OpenFile(MagicDy[File_index]);
		ReadFile();
		CloseFile();
		convert();
		TFCard_Deinit();
...
void ShowFPGA(void)
{
		const char* boot[24]={"0:boot.txt","0:boot1.txt","0:boot2.txt","0:boot3.txt",
...
//												"0:boot40.txt","0:boot41.txt","0:boot42.txt","0:boot43.txt",
	...
	speed = 7;
	for(Totem_index = 0;Totem_index<20;Totem_index++)  //44个文件
	{
		TFCard_Init();
...
void ShowCUBE(void)
{
	int File_index=0;
	speed = 8;
	for(File_index=0;File_index<130;File_index++)
	{
		TFCard_Init();		
...
//		{
//			
//			for(loop_start = 4752+36*j; loop_start >= 3456+36*j; loop_start-=432)					
//			{
//				for(t=0;t<12;t++)
//				{
//					WriteData(0,0,0);
